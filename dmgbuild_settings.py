...
APPNAME = "MetGem"
# noinspection PyUnresolvedReferences
PACKAGING_DIR = defines.get('packaging_dir', os.path.dirname(__file__))
...
shutil.copytree(f'{PACKAGING_DIR}/metgem/examples', os.path.join(tmp_dir.name, APPNAME, 'examples'))
